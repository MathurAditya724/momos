...
export type Logo = ComponentProps<"svg">;
...
export function Logo({ className, ...props }: Logo) {
  return (
    <svg
      ...
      className={cn("w-32 dark:fill-white", className)}
    >
      <title>Momos</title>
      <defs>
        <linearGradient
...
export function LogoIcon({ className, ...props }: Logo) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"
      viewBox="0 0 465 261"
      className={cn("size-8 dark:fill-white", className)}
    >
      <title>Momos</title>
      <defs>
        <linearGradient
